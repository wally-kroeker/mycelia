...
// migration0007 (v1.2 structured coordination fields) is additive ALTERs; the
// request-create INSERT in routes/requests.ts binds these columns, so the test
// schema must carry them.
const MIGRATIONS = [migration0001, MIGRATION_0002_TEST_STUB, migration0003, migration0004, migration0006, migration0007];
