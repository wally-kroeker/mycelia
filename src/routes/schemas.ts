 ...
 *
 * Original credit: Robert Chuvala (NorthwoodsSentinel/mycelia fix/claim-handler-batch,
 * commit ca34bc12, 2026-06-27). Upstreamed with body_tier + scope_claim corrections.
 *
 * Endpoints:
  ...
  request_create: {
    ...
    body: {
      ...
      scope_claim: {
        type: 'object',
        required: true,
        notes: 'Shape: { requester, agent_id, tier, ask_max_tier, ts }. Required on fleet/company nodes. Community nodes synthesize a public-tier fallback for absent scope_claim (with a logged warning). Tier vocabulary: public < cohort < personal < sealed.',
      },
  ...
  response_create: {
    ...
    body: {
      ...
      body_tier: {
        ...
        required: false,
        default: 'public',
        enum: ['public', 'cohort', 'personal', 'sealed'],
        notes: 'Content sensitivity tier of the response body. Must not exceed the requester\'s ask_max_tier. sealed is always refused at the fleet boundary.',
      },
    },
  },
  rating_create: {
